...
AWS API endpoint (Python/SAM) in `cloud/` — companion to the ESP32 edge device. Requires mTLS authentication via trusted certificates in S3 bucket `supervictor`. Endpoint: `supervictor.advin.io`.
