...
Rust API endpoint in `endpoint/` — companion to the ESP32 edge device. Drop-in replacement for `cloud/` Python API. Uses axum + Lambda Web Adapter for SAM deployment, architected for ECS migration.
